---
name: prompt-armor
description: Detect prompt injection, jailbreaks, and adversarial attacks in LLM inputs before processing. 5 analysis layers, F1 86.9% internal / 98.87% external, ~24ms, runs offline.
version: 0.6.0
